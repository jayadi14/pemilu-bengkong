                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="card mt-4">
                                <div class="card-header bg-secondary text-white">
                                    <h4>Calon Presiden & Wakil Presiden</h4>
                                </div>                                             
                                <div class="card-body">
                                    <!-- Table Data -->
                                    <div class="table-responsive"> 
                                            ...
                                            <table id="dt" class="display nowrap" style="width:100%">
                                                ...
                                                <?php
                                                $no = 1;
                                                $tampil = mysqli_query($koneksi, "SELECT * FROM tb_presiden ORDER BY id_presiden DESC");
                                                          ...
                                                          <div class="modal-dialog">
                                                            <div class="modal-content">
                                                              <div class="modal-header">
                                                                <h5 class="modal-title" id="staticBackdropLabel">Form Input Suara Capres & Cawapres</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                              </div>
                                                              <form method="post" action="aksi.php">
                                                                <input type="hidden" name="id_presiden" value="<?= $data['id_presiden']?>">
