                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="card mt-4">
                                <div class="card-header bg-secondary text-white">
                                    <h4>Calon Presiden & Wakil Presiden Kecamatan Batu Ampar</h4>
                                </div>                                             
                                <div class="card-body">
                                    <!-- Table Data -->
                                    <div class="table-responsive">                                            
                                            ...
                                            <table id="dt" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>    
                                                    ...
                                                    $sql = ("SELECT SUM(paslon_1) AS total_jumlah FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    ...
                                                    $sql = ("SELECT (SUM(paslon_1) / (SELECT SUM(surat_suara) FROM tb_presiden WHERE kecamatan='BATU AMPAR')) * 100 AS persentase FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    $result = $koneksi->query($sql);
                                                    ...
                                                    $sql = ("SELECT SUM(paslon_2) AS total_jumlah FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    $result = $koneksi->query($sql);
                                                    ...
                                                    $sql = ("SELECT (SUM(paslon_2) / (SELECT SUM(surat_suara) FROM tb_presiden WHERE kecamatan='BATU AMPAR')) * 100 AS persentase FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    $result = $koneksi->query($sql);
                                                    ...
                                                    $sql = ("SELECT SUM(paslon_3) AS total_jumlah FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    $result = $koneksi->query($sql);
                                                    ...
                                                    $sql = ("SELECT (SUM(paslon_3) / (SELECT SUM(surat_suara) FROM tb_presiden WHERE kecamatan='BATU AMPAR')) * 100 AS persentase FROM tb_presiden WHERE kecamatan='BATU AMPAR'");
                                                    $result = $koneksi->query($sql);
                            ...
                            <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
                                    ...
                                    function drawChart() {
                                      ...
                                      var options = {
                                        title: "GRAFIK SUARA CALON PRESIDEN DAN WAKIL PRESIDEN KECAMATAN BATU AMPAR",
                                        width: 900,
                                        height: 400,
                                        bar: {groupWidth: "95%"},
