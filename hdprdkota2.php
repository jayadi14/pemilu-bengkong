...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Situng BATU AMPAR</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="card mt-4">
                                <div class="card-header bg-success text-white">
                                    <h4>Calon DPRD Kota Kecamatan Batu Ampar</h4>
                                </div>                                             
                                <div class="card-body">
                                    <!-- Table Data -->
                            ...
                            <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
                                    ...
                                    function drawChart() {
                                      ...
                                      var options = {
                                        title: "GRAFIK SUARA CALON DPRD KOTA KECAMATAN BATU AMPAR",
                                        width: 900,
                                        height: 400,
                                        bar: {groupWidth: "95%"},
