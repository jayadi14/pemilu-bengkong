...
if (isset($_POST['bhapus1'])) {
	...
	$hapus = mysqli_query($koneksi, "DELETE FROM tb_dprd_prov1 WHERE id_dprdprov1 ='$_POST[id_dprdprov1]'");
...
if (isset($_POST['bhapus'])) {
	...
	$hapus = mysqli_query($koneksi, "DELETE FROM tb_dprd_prov WHERE id_dprdprov ='$_POST[id_dprdprov]'");
